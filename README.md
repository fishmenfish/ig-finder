...
Install and update from [OpenUserJS](https://openuserjs.org/scripts/fishmanfish/Instagram_Non-Followers_Finder). The script has the `membership` antifeature because it requires an Instagram account and uses Instagram web endpoints.
